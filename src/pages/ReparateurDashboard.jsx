...
export default function ReparateurDashboard() {
  ...
  const handleSubmit = async () => {
    // Validate: NOK must have at least one reason
    ...
    setSubmitting(true)
    try {
      // Get or create tracking sheet for this quarter
      const now = new Date()
      ...
      const weeklyCheck = {
        ...
        inspectorMatricule: user.matricule || user.username,
      ...
      await api.post(`/sheets/${sheet.id}/weekly`, weeklyCheck)
      setSuccess(true)
      ...
      <div style={{ padding: "2rem", maxWidth: "1000px", margin: "0 auto" }}>
        ...
        {success && (
          <div style={{
            ...
            ✓ Contrôle hebdomadaire soumis avec succès
          </div>
        )}
          ...
          <div style={{
            ...
            <div style={{
              ...
              <h2 style={{ fontSize: "16px", fontWeight: 500 }}>
                Sélectionnez une valise à contrôler
              </h2>
            </div>
            {loading ? (
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontWeight: 500, fontSize: "16px" }}>
                  Contrôle hebdomadaire — {selectedValise.valiseNumber}
                </div>
